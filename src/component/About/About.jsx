        ...
        <div className={styles.wrapper}>
          <ul className={styles.about}>
            <li>
              <h3>About me</h3>
              <p>
                Hello there! I'm Kévin Sauvage, a dedicated full-stack web developer with two years
                of experience under my belt. With a passion for creating seamless and responsive
                user experiences, I have honed my skills in various programming languages and
                frameworks, making me capable of delivering top-notch web solutions.
              </p>
            </li>
            <li>
              <h3>Expertise</h3>
            ...
            <li>
              ...
              <p>
                ...
                utilizing responsive design principles and popular JavaScript libraries to design
                and develop high-quality web applications
              </p>
            </li>
            <li>
              <h3>Interests</h3>
            ...
            <li>
              ...
              <p>
                ...
                would be delighted to hear from you. Please don't hesitate to contact me or view my
