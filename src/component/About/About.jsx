      ...
      <div className={styles["About__container"]}>
        <SlideUpAndFadeIn>
          <p>
            ...
            autonomous, committed, with a "can-do" attitude and always enthusiastic about learning
            new things. My past experience in the commerce industry brings me powerful communication
            skills, and the ability to create strong working relationships.
            <br />
            <br />
