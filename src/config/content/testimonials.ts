...
const testimonials: Testimonial[] = [
  {
    ...
    excerpt:
      'From day one, he showed a rare ability to take on the most complex technical challenges and find pragmatic solutions. His ability to adapt quickly, understand the bigger picture, and deliver impact made him an invaluable asset in both contexts. I would gladly work with Kevin again — any organization would be lucky to have him.',
    date: 'September 2025',
  },
  {
    ...
    excerpt:
      'I was impressed by his ability to rapidly grow his skills and deepen his understanding of our context, becoming a key asset to our team. He quickly became a pillar of his new team, thriving in a multicultural and decentralized environment.',
    date: 'September 2025',
  },
  {
    ...
    excerpt:
      "He's one of those rare developers who can quickly understand a new environment and start adding value from day one. He's not afraid to challenge existing foundations when he sees an opportunity for improvement — always in a constructive way that elevates the entire team.",
    date: 'November 2025',
  },
];
