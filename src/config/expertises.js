const services = [
  {
    content:
      'I create intuitive and responsive web experiences using the latest frameworks and technologies. My expertise ensures that websites are fast, efficient, and easy to use on all devices.',
