...
import { Body, BodySmall, H4, H5 } from '@/components/Typography';
        ...
        <div className='flex items-start justify-between mb-6'>
          <div className='flex items-start gap-4 flex-1'>
            ...
            <div className='flex-1 min-w-0'>
              <H4
                id={`cert-${index}`}
                className='group-hover:text-primary-400 transition-all duration-300 text-xl md:text-2xl leading-tight mb-2'
              >
                {title}
              </H4>
              <div className='flex items-center gap-4 flex-wrap'>
                <div className='flex items-center gap-2'>
                  <Building2
                    ...
                    aria-hidden='true'
                  />
                  <H5 className='text-zinc-300 group-hover:text-zinc-200 transition-colors'>
                    {issuer}
                  </H5>
                </div>
                <div className='flex items-center gap-2'>
        ...
        <div className='space-y-4'>
          ...
          {credentialUrl && (
            <a
              ...
              className='inline-flex items-center gap-2 py-2 text-sm font-medium text-primary-300 rounded-lg hover:text-primary-200 transition-all duration-300 group/link'
            >
              <ExternalLink
                size={iconSizes.sm}
