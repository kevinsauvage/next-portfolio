      ...
      blocs: [
        {
          ...
          description:
            "The user can open the product modal, add a product to the card and click the order button to go to the order page.",
          image:
      ...
      blocs: [
        {
          ...
          description:
            "Accordion Slider is a kind of slider design pattern that enables the user to slides just like an accordion.",
          image:
        ...
        },
        {
          ...
          description: "The user can save movies and series that he wants to watch.",
          image:
        ...
        },
        {
          ...
          description:
            "The user can check out all the details of a movie or a series, play the trailer, add it to his watch list and look at what other users said about it.",
          image:
            "https://res.cloudinary.com/kevincloudname/image/upload/v1650287740/portfolio/StreamShowPage_mqpakq.png",
        },
        {
          title: "Trailer",
          description: "The user can display the trailer of every movie or series.",
          image:
            "https://res.cloudinary.com/kevincloudname/image/upload/v1650287740/portfolio/StreamyTrailer_wabka2.png",
        },
        {
          title: "Slideshow",
          description: "A slideshow component for cycling through movies and series.",
          image:
